...
public class CreateStudents extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        regno.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateStudents.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreateStudents().setVisible(true);
            }
        });
    }
